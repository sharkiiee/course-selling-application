  ...
  return (
    <div className={styles.videoContainer}>
      ...
      <div className={styles.textOverlay}>
        <div style={{display:"flex", textTransform:"none", textAlign:"center", alignItems:"center", justifyContent:"center", gap:"10px", fontSize:"1rem", fontWeight:"500"}}>
        ...
        <div  className={styles.inputContainer}>
          ...
          <input type="text" placeholder="Search for courses, topics, technologies..." />  
        </div>
      </div>
    </div>
  );
